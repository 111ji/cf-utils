...
/**
 *
 * <b style="color:#e94d08;">程序公共全局变量</b>
 *
 */
public class Global
{
	 ...
	 * session name
	 */
	public static final String SESSION_NAME_USER = "careerforce_session_user";

	/**
	 * request loged user name
	 */
	public static final String REQUEST_NAME_USER = "loged_user";
	 ...
	 * 加密密钥
	 */
	public static final String random_str_for_encrypt = "yghkfsdew";
	/**
	 * 标签分隔符
	 */
	 ...
	 * 登录方式： QQ互联
	 */
	public static final String LOGIN_OPT_CONNECT_QQ = "qq";
	/**
	 * 登录方式： 微博
	 */
	public static final String LOGIN_OPT_CONNECT_WEIBO = "weibo";
	/**
	 * 登录方式： 微信
	 */
	public static final String LOGIN_OPT_CONNECT_WEIXIN = "weixin";
	/**
	 * 登录方式： 老尚技
	 */
	public static final String LOGIN_OPT_CONNECT_SONGEE = "songee";
	/**
	 * 登录方式： 尚技（111ji）
	 */
	public static final String LOGIN_OPT_CONNECT_111JI = "111ji";

	/**
	 * action operations
	 */
	public static final String OPERATION_VIEW = "view";
	public static final String OPERATION_TOADD = "toadd";
	public static final String OPERATION_ADD = "add";
	public static final String OPERATION_TOUPDATE = "toupdate";
	public static final String OPERATION_UPDATE = "update";
	public static final String OPERATION_LIST = "list";
	public static final String OPERATION_DELETE = "delete";
	public static final String OPERATION_ERROR = "error";
	public static final String NO_AUTHEN_RES = "noauth";
	public static final String OPERATION_PTEXT = "ptext";

	/**
	 * YES：y
	 */
	public static final String CHECK_RESULT_YES = "y";
	/**
	 * NO：n
	 */
	public static final String CHECK_RESULT_NO = "n";

	/**
	 * Resource types：图片，0
	 */
	public static final long RESOURCE_TYPE_PICTURE = 0L;
	public static final long RESOURCE_TYPE_FILE = 1L;
	public static final long RESOURCE_TYPE_VIDEO = 2L;
	public static final long RESOURCE_TYPE_COURSE = 3L;

	// operation result
	public static final int OPERATION_SUCCESS = 0;
	public static final int OPERATION_FAILD = 1;
	public static final int WRONG_RAND_NUMBER = 2;
	public static final int DATA_EXIST = 3;
	public static final int NO_AUTHENTICATION = 5;
	public static final int WRONG_USER_NAME = 6;
	public static final int WRONG_USER_PASS = 7;
	public static final int INVALID_USER = 8;
	public static final int INVALID_DATA = 9;
	public static final int USERNAME_EXIST = 10;
	public static final int USER_EMAIL_EXIST = 11;
	public static final int USER_ALREADY_BIND = 13;
	public static final int OPERATION_OTHRE_RESULT = 12;
	public static final int AUDIT_SUCCESS = 13;

	public static final int VALICODE_NOT_EXIST = 16;
	public static final int VALICODE_OVER_TIME = 17;

	public static final int POINT_USER_ENOUGH = 97;
	public static final int PASS_OF_DATE = 98;
	public static final int USER_INFO_NONE = 99;
	...
	public static String contentReplace(String content)
	{
		for (int i = 0; i < filterContent.length; i++)
			content = content.replace(filterContent[i], "*");
		return content;
	}
	...
	public static String getResultMessage(int res)
	{
		switch (res)
		{
			case Global.OPERATION_SUCCESS:
				return "操作成功";
			case Global.OPERATION_FAILD:
				return "操作失败";
			case Global.WRONG_RAND_NUMBER:
				return "验证码错误";
			case Global.DATA_EXIST:
				return "输入错误或记录已存在";
			case Global.NO_AUTHENTICATION:
				return "您没有权限进行该操作";
			case Global.WRONG_USER_NAME:
				return "错误的用户名";
			case Global.WRONG_USER_PASS:
				return "密码错误";
			case Global.INVALID_USER:
				return "无效的用户(未激活或已注销)";
			case Global.INVALID_DATA:
				return "输入错误或信息无效";
			case Global.USERNAME_EXIST:
				return "昵称已存在";
			case Global.USER_EMAIL_EXIST:
				return "邮箱已存在";
			case Global.VALICODE_NOT_EXIST:
				return "验证码有误";
			case Global.VALICODE_OVER_TIME:
				return "验证码已过期";
			default:
				return "处理失败，请检查您的操作";
		}
