...
/**
 * <b style="color:#e94d08;">数据检查辅助类</b>
 *
 * @author zzdl
 */
public final class Check
{
     ...
     *
     * @param str       字符串
     * @param withComma 是否允许有逗号
     * @return 是否符合
     */
    public static boolean isNumber(String str, boolean withComma)
    {
        Pattern pattern = Pattern.compile("^[0-9" + (withComma ? "," : "") + "]+$");
